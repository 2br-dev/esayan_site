<div id="pvzMapWrapper" class="selectPvz {if empty($delivery_pvz_list)}selectPvz_empty{else}rs-selectPvz{/if}" data-pvz-json='{$pvz_json}' data-dialog-options='{ "width" : "95%", "height" : "95%" }' style="width: 89vw; height: 82vh;">
